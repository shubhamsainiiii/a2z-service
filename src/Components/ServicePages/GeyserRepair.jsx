...
import { MdOutlinePlumbing } from "react-icons/md"; // Changed to plumbing-related icon
...
const GeyserRepair = () => {
    return (
        <div className="bg-gradient-to-b from-[#A3CCDA] via-indigo-200 to-[#E7F2EF]">
            <section className="h-116 relative bg-center bg-cover text-white bg-[url('/src/assets/GBg.webp')] mt-18">
                <div className="absolute inset-0 bg-black/60"></div>
                <div className="relative z-10 max-w-7xl mx-auto px-6 py-30 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">
                        Geyser Repair & Installation Services
                    </h1>
                    <p className="text-lg md:text-xl mb-6">
                        Professional Geyser Installation, Repair & Maintenance Solutions
                    </p>
                    <a
            ...
            <section className="max-w-7xl mx-auto px-6 py-16">
                <h2 className="text-4xl font-bold bg-gradient-to-br from-gray-950 via-indigo-700  to-gray-800 bg-clip-text text-transparent text-center mb-10 p-1">
                    Complete Geyser Repair & Maintenance Solutions
                </h2>
                ...
                <div className="md:flex items-center justify-center gap-16">
                    <div className="md:w-1/2 space-y-4 md:text-left text-justify">
                        ...
                        <p className="text-gray-900 leading-relaxed">
                            Our expert team handles all leading geyser brands and models. We
                    ...
                    {[
                        {
                            ...
                            desc: "Professional setup for new geysers and water heaters.",
                        },
                        {
                            icon: <FaTools size={40} />,
                            title: "Heating Element Repair",
                            desc: "Fixing temperature and heating issues efficiently.",
                        },
                        {
                            icon: <FaFireAlt size={40} />,
                            title: "Leak & Pipe Repair",
                            desc: "Prevent water wastage with expert leak fixes.",
                        },
                        {
