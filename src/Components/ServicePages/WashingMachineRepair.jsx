...
const WashingMachineRepair = () => {
    return (
        <div className="bg-gradient-to-b from-[#A3CCDA] via-indigo-200 to-[#E7F2EF]">
            <section className="h-116 relative bg-center bg-cover text-white bg-[url('/src/assets/WMBg.webp')] mt-18">
                <div className="absolute inset-0 bg-black/60"></div>
                <div className="relative z-10 max-w-7xl mx-auto px-6 py-30 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">
                        Washing Machine Repair & Installation Services
                    </h1>
                    <p className="text-lg md:text-xl mb-6">
                        Professional Washing Machine Repair, Installation & Maintenance Solutions
                    </p>
                    <a
            ...
            <section className="max-w-7xl mx-auto px-6 py-16">
                <h2 className="text-4xl font-bold bg-gradient-to-br from-gray-950 via-indigo-700  to-gray-800 bg-clip-text text-transparent text-center mb-10 p-1">
                    Complete Washing Machine Repair & Maintenance Solutions
                </h2>
                <div className="md:flex items-center justify-center gap-16">
                    <div className="md:w-1/2 space-y-4 md:text-left text-justify">
                        <p className="text-gray-900 leading-relaxed">
                            ...
                            affordable washing machine repair, installation, and maintenance services in Jaipur.
                            From drum repair to motor servicing and leak fixes, we ensure your
                            washing machine works efficiently and lasts longer.
                        </p>
                        <p className="text-gray-900 leading-relaxed">
                            Our expert team handles all leading washing machine brands and models.
                            We guarantee on-time service, genuine spare parts, and professional
                    ...
                    <div className="md:w-1/2 mt-8 md:mt-0 flex justify-center">
                        <ul className="space-y-3 text-gray-900 mr-5">
                            <li className="flex items-center">
                                ...
                                Washing Machine Installation & Setup
                            </li>
                            <li className="flex items-center">
                                <FaCheckCircle className="text-indigo-500 mr-2" />
                                Drum Jam or Noise Problem Repair
                            </li>
                            <li className="flex items-center">
                                <FaCheckCircle className="text-indigo-500 mr-2" />
                            ...
                            <li className="flex items-center">
                                <FaCheckCircle className="text-indigo-500 mr-1" />
                    ...
                    {[
                        {
                            ...
                            desc: "Professional setup for all types of washing machines.",
                        },
                        {
                            icon: <FaTools size={40} />,
                            title: "Motor & Drum Repair",
                            desc: "Fixing motor, drum, and mechanical issues efficiently.",
                        },
                        {
                            icon: <FaWater size={40} />,
                            title: "Leak & Pipe Repair",
                            desc: "Prevent water leakage and ensure smooth operation.",
                        },
                        {
            ...
            <section className="bg-indigo-400 text-white text-center py-16">
                <h2 className="text-3xl font-bold mb-4">
                    Book Your Washing Machine Service Appointment Today!
                </h2>
                <p className="text-lg mb-6">
                    Get expert washing machine installation, repair & maintenance at your doorstep in Jaipur.
                </p>
                <a
                    href="tel:+919251288005"
